    ...
    return <div>
        ...
        <div className="flex justify-center">
            <div onClick={() => {
                ...
                setInsertMode(true);
            }} className="font-mono bg-zinc-300 text-xl rounded-md py-2 text-center hover:cursor-pointer font-semibold w-100 mt-4">Add Project</div>
        </div>

        {
            ...
            <div className="fixed inset-0 bg-amber-50 shadow-3xl rounded-lg flex justify-center px-16 py-2 z-50 my-30 mx-50">
                <div className="flex justify-center full-screen">
                    <Adder inputType="projects" setInsertMode={setInsertMode}/>
                </div>
            </div>
        }
    </div>
